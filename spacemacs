...
you should place your code here."
  ...
  (spacemacs/set-leader-keys
    ...
    "og" (lambda () "Git grep repository from root" (interactive) (let ((current-prefix-arg '(4))) (call-interactively 'helm-grep-do-git-grep)))

  ...
  (setq org-agenda-custom-commands
        '(("b" "Blocked and Waiting items" ((tags-todo "TODO=\"BLOCKED\"|TODO=\"WAITING\"|TODO=\"PR\"")))
          ...
          ("wa" "Today's agenda and WORK items" ((agenda "" ((org-agenda-span 'day)
                                                             (org-agenda-archives-mode t)
                                                             (org-agenda-log-mode t)))
                                                 (tags-todo "+WORK&-TODO=\"BLOCKED\"&-TODO=\"WAITING\"&-HOME")))
          ("wb" "WORK Blocked and Waiting items" ((tags-todo "-HOME+WORK+TODO=\"BLOCKED\"|+WORK+TODO=\"WAITING\"|+WORK+TODO=\"PR\"")))
          ("wc" "Currently active non-repeating WORK items" tags-todo "-HOME+WORK-SOMEDAY-REPEATING")
          ("we" "Work agenda for exporting to html" ((agenda "" ((org-agenda-span 'day)
                                                                 (org-agenda-archives-mode t)
                                                                 (org-agenda-log-mode t)))
                                                     (tags-todo "-HOME+WORK-TODO=\"BLOCKED\"-TODO=\"WAITING\"")))
          ("ws" "Search WORK items" ((tags-todo "-HOME+WORK") (search "")))
          ("ww" "All WORK items" tags-todo "-HOME+WORK")))

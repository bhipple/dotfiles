(with-eval-after-load 'org
  ...
  (setq org-agenda-custom-commands
        '(("b" "Blocked and Waiting items" ((tags-todo "TODO=\"BLOCKED\"|TODO=\"WAITING\"|TODO=\"PR\"")))
          ...
          ("p" . "Project searches")
          ("pa" "Project List (All)" ((tags (concat "+PROJECT" brh-org-non-actionable) (org-agenda-use-tag-inheritance nil))))
          ("pl" "Project List (Active)" ((tags (concat "+PROJECT-SOMEDAY" brh-org-non-actionable) (org-agenda-use-tag-inheritance nil))))
          ...
          ("wa" "Today's agenda and WORK items" ((agenda "" ((org-agenda-span 'day)
                                                             (org-agenda-archives-mode t)
                                                             (org-agenda-log-mode-items '(closed clock state))))
                                                 (tags-todo (concat "+WORK-INBOX-SOMEDAY-REPEATING" brh-org-non-actionable)))
                                                 (tags-todo "+INBOX")
                                                 ((org-agenda-tag-filter-preset '("+WORK"))))
          ("wb" "WORK Blocked and Waiting items" ((tags-todo "+WORK+TODO=\"BLOCKED\"|+WORK+TODO=\"WAITING\"|+WORK+TODO=\"PR\"")))
          ("wc" "Currently active non-repeating WORK items" tags-todo (concat "+WORK-SOMEDAY-REPEATING" brh-org-non-actionable))
